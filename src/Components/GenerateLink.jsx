  ...
  return (
    <div className="w-full max-w-7xl mx-auto">
      ...
      <div className="w-full flex flex-col gap-10 md:flex-row mx-auto justify-between items-center px-10">
        <form className="w-full min-h-[450px] bg-gray-100 dark:bg-gray-800 max-w-lg flex flex-col gap-6 p-4 md:p-10 rounded-2xl shadow-sm lg:shadow-lg dark:shadow-slate-700" id="generateWsp">
          <div>
